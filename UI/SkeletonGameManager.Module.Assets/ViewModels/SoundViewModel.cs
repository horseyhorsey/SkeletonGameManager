...
namespace SkeletonGameManager.Module.Assets.ViewModels
{
    public class SoundViewModel : AssetFileBaseViewModel
    {
        ...
        public void SetAudioType(AssetTypes assetType)
        {
            AudioType = assetType;
        ...
        public async override Task GetFiles()
        {
            ...
            var audioFiles = await _skeletonGameFiles.GetFilesAsync(_audioPathFull.AbsolutePath, AudioType);
